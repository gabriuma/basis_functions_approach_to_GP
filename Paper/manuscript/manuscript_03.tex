...
%Sparse GPs alleviate the computational demands for small and medium amounts of data but, due to 
...
\begin{figure}[H]
\centering
\subfigure{\includegraphics[scale=0.350]{fig10_MSE_exI_inter.pdf}}
\subfigure{\includegraphics[scale=0.350]{fig10_MSE_exI_extra.pdf}}
