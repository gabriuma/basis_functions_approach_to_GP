...
\begin{figure}
\centering
\subfigure{\includegraphics[scale=0.38, trim = 5mm 0mm 5mm 0mm, clip]{fig1_Post_J.pdf}}
\subfigure{\includegraphics[scale=0.38, trim = 0mm 0mm 10mm 0mm, clip]{fig1_Cov_J.pdf}}
\subfigure{\includegraphics[scale=0.40, trim = 27mm 32mm 122mm 10mm, clip]{fig1_legend.pdf}}
...
\begin{figure}
\centering
\subfigure{\includegraphics[scale=0.38, trim = 5mm 0mm 5mm 0mm, clip]{fig2_Post_L.pdf}}
\subfigure{\includegraphics[scale=0.38, trim = 0mm 0mm 10mm 0mm, clip]{fig2_Cov_L.pdf}}
\subfigure{\includegraphics[scale=0.40, trim = 27mm 32mm 120mm 0mm, clip]{fig2_legend.pdf}}
...
\hline
c  = 1.05 & \includegraphics[scale=0.23, trim = 0mm 14mm 0mm 14mm, clip]{fig3_Post_part1.pdf} & \includegraphics[scale=0.23, trim = 0mm 14mm 0mm 14mm, clip]{fig3_Cov_part1.pdf} & \multirow{36}{1.3cm}{\includegraphics[scale=0.35, trim = 28mm 40mm 100mm 30mm, clip]{fig3_legend.pdf}}\\ 
\cline{1-3}
c  = 1.1 & \includegraphics[scale=0.23, trim = 0mm 14mm 0mm 14mm, clip]{fig3_Post_part2.pdf} & \includegraphics[scale=0.23, trim = 0mm 14mm 0mm 14mm, clip]{fig3_Cov_part2.pdf} &\\
\cline{1-3}
c  = 1.2 & \includegraphics[scale=0.23, trim = 0mm 14mm 0mm 14mm, clip]{fig3_Post_part3.pdf} & \includegraphics[scale=0.23, trim = 0mm 14mm 0mm 14mm, clip]{fig3_Cov_part3.pdf} &\\
\cline{1-3}
c  = 1.5 & \includegraphics[scale=0.23, trim = 0mm 14mm 0mm 14mm, clip]{fig3_Post_part4.pdf} & \includegraphics[scale=0.23, trim = 0mm 14mm 0mm 14mm, clip]{fig3_Cov_part4.pdf} & \\
\cline{1-3}
c  = 2 & \includegraphics[scale=0.23, trim = 0mm 14mm 0mm 14mm, clip]{fig3_Post_part5.pdf} &  \includegraphics[scale=0.23, trim = 0mm 14mm 0mm 14mm, clip]{fig3_Cov_part5.pdf} &\\
\cline{1-3}
c  = 2.5 & \includegraphics[scale=0.23, trim = 0mm 4mm 0mm 14mm, clip]{fig3_Post_part6.pdf} & \includegraphics[scale=0.23, trim = 0mm 4mm 0mm 14mm, clip]{fig3_Cov_part6.pdf} &\\
\hline
\end{tabular}
\end{center}
...
\begin{figure}
\centering
\subfigure{\includegraphics[scale=0.38, trim = 0mm 0mm 0mm 0mm, clip]{fig4_MSE_vs_J.pdf}}
\subfigure{\includegraphics[scale=0.38, trim = 0mm 0mm 10mm 0mm, clip]{fig4_MSE_vs_c.pdf}}
...
\begin{figure}
\centering
\subfigure{\includegraphics[scale=0.38, trim = 0mm 0mm 5mm 0mm, clip]{fig5_lscale_vs_J.pdf}}
\subfigure{\includegraphics[scale=0.38, trim = 0mm 0mm 10mm 0mm, clip]{fig5_magnitud_vs_J.pdf}}
\subfigure{\includegraphics[scale=0.40, trim = 28mm 28mm 119mm 0mm, clip]{fig5_legend.pdf}}
...
\begin{figure}
\centering
\subfigure{\includegraphics[scale=0.40, trim = 0mm 0mm 5mm 0mm, clip]{fig6_lscale_vs_J_vs_c.pdf}}
\hspace{3mm}
\subfigure{\includegraphics[scale=0.40, trim = 0mm 0mm 5mm 0mm, clip]{fig6_lscale_vs_J_vs_c_zoomin.pdf}}
...
\begin{figure}
\centering
\subfigure{\includegraphics[scale=0.40, trim = 0mm 0mm 5mm 0mm, clip]{fig6_lscale_vs_J_vs_c_Matern.pdf}}
\hspace{3mm}
\subfigure{\includegraphics[scale=0.40, trim = 0mm 0mm 5mm 0mm, clip]{fig6_lscale_vs_J_vs_c_zoomin_Matern.pdf}}
...
\begin{figure}
\centering
\subfigure{\includegraphics[scale=0.4, trim = 10mm 100mm 5mm 30mm, clip]{fig7_legend.pdf}}\\
\vspace{-3mm}
\subfigure{\includegraphics[scale=0.31, trim = 10mm 25.5mm 10mm 19mm, clip]{fig7_posterior_varing_lscale_part1.pdf}}
\subfigure{\includegraphics[scale=0.31, trim = 21mm 25.5mm 10mm 19mm, clip]{fig7_posterior_varing_lscale_part2.pdf}}
\subfigure{\includegraphics[scale=0.31, trim = 21mm 25.5mm 10mm 19mm, clip]{fig7_posterior_varing_lscale_part3.pdf}}\\
\vspace{-3mm}
\subfigure{\includegraphics[scale=0.31, trim = 10mm 25.5mm 10mm 19mm, clip]{fig7_posterior_varing_lscale_part4.pdf}}
\subfigure{\includegraphics[scale=0.31, trim = 21mm 25.5mm 10mm 19mm, clip]{fig7_posterior_varing_lscale_part5.pdf}}
\subfigure{\includegraphics[scale=0.31, trim = 21mm 25.5mm 10mm 19mm, clip]{fig7_posterior_varing_lscale_part6.pdf}}\\
\vspace{-3mm}
\subfigure{\includegraphics[scale=0.31, trim = 10mm 5mm 10mm 19mm, clip]{fig7_posterior_varing_lscale_part7.pdf}}
\subfigure{\includegraphics[scale=0.31, trim = 21mm 5mm 10mm 19mm, clip]{fig7_posterior_varing_lscale_part8.pdf}}
\subfigure{\includegraphics[scale=0.31, trim = 21mm 5mm 10mm 19mm, clip]{fig7_posterior_varing_lscale_part9.pdf}}\\
\vspace{-3mm}
...
\subfigure{\includegraphics[scale=0.40, trim = 28mm 55mm 110mm 0mm, clip]{fig11_MSE_exI_legend.pdf}}
...
\begin{figure}
\centering
\subfigure{\includegraphics[scale=0.38, trim = 0mm 0mm 5mm 0mm, clip]{fig14_MSE_train_gaydata.pdf}}
\subfigure{\includegraphics[scale=0.38, trim = 0mm 0mm 10mm 0mm, clip]{fig14_MSE_pred_gaydata.pdf}}
\subfigure{\includegraphics[scale=0.40, trim = 25mm 30mm 123mm 0mm, clip]{fig14_legend_gaydata.pdf}}
...
\begin{center}
\begin{tabular}{ c c c}
\includegraphics[scale=0.35, trim = 0mm 33mm 35mm 20mm, clip]{fig15_truefun_exII.pdf} & \hspace{-5mm} \includegraphics[scale=0.35, trim = 19mm 33mm 35mm 20mm, clip]{fig15_gpfun_exII.pdf} & \hspace{-5mm}\multirow{-5.5}{*}{ \includegraphics[scale=0.35, trim = 150mm 20mm 0mm 10mm, clip]{fig15_colorbar_vertical_exII.pdf}}\\ 
\includegraphics[scale=0.35, trim = 0mm 22mm 35mm 20mm, clip]{fig15_bffun_exII.pdf}  & \hspace{-5mm} \includegraphics[scale=0.35, trim = 19mm 22mm 35mm 20mm, clip]{fig15_spfun_exII.pdf}
\end{tabular}
\end{center}
...
\begin{figure}
\centering
\subfigure{\includegraphics[scale=0.35, trim = 8mm 23mm 39.2mm 20mm, clip]{fig16_errorGP_exII.pdf}}
\subfigure{\includegraphics[scale=0.35, trim = 19mm 23mm 39.2mm 20mm, clip]{fig16_errorHSGP_exII.pdf}}
\subfigure{\includegraphics[scale=0.35, trim = 19mm 23mm 39.2mm 20mm, clip]{fig16_errorSP_exII.pdf}}
\subfigure{\includegraphics[scale=0.33, trim = 149mm 20mm 0mm 20mm, clip]{fig16_error_colorbar_exII.pdf}}
...
\begin{figure}
\centering
\subfigure{\includegraphics[scale=0.38, trim = 0mm 0mm 5mm 0mm, clip]{fig17_RMSE_exII.pdf}}
\subfigure{\includegraphics[scale=0.38, trim = 0mm 0mm 10mm 0mm, clip]{fig17_time_exII.pdf}}
\subfigure{\includegraphics[scale=0.40, trim = 28mm 30mm 123mm 0mm, clip]{fig17_legend_exII.pdf}}
...
\begin{figure}
\centering
\subfigure{\includegraphics[scale=0.35, trim = 12mm 23mm 35mm 20mm, clip]{fig18_gpfun_diabetes.pdf}}
\subfigure{\includegraphics[scale=0.35, trim = 20mm 23mm 35mm 20mm, clip]{fig18_bffun_diabetes.pdf}}
\subfigure{\includegraphics[scale=0.35, trim = 20mm 23mm 38mm 20mm, clip]{fig18_spfun_diabetes.pdf}}
...
\begin{figure}
\centering
\subfigure{\includegraphics[scale=0.29, trim = 0mm 0mm 10mm 0mm, clip]{fig20_time2D_diabetes_2.pdf}}
\subfigure{\includegraphics[scale=0.29, trim = 30.2mm 0mm 10mm 0mm, clip]{fig20_time3D_diabetes_2.pdf}}
\subfigure{\includegraphics[scale=0.29, trim = 30.2mm 0mm 10mm 0mm, clip]{fig20_time4D_diabetes_2.pdf}}
\subfigure{\includegraphics[scale=0.40, trim = 25mm 53mm 123mm 10mm, clip]{fig20_legend_diabetes_2.pdf}}
\caption{Time of computation in the log scale of the different models fitted over the dataset with 2 input dimensions (left) and 3 input dimensions (center) and 4 input dimensions (right), as a function of the boundary factor $c$, number of basis functions $m$ and knots.}
  \label{fig20_time2D_diabetes}
\end{figure}
...
%\subsection{Study case VII: Land use spatio-temporal classification task (first form)}\label{sec:bf_caseVII}
...
%
%In order to avoid high-order components in the additive HSGP model as much as possible, since it is known multivariate HSGP models to be computationally demanding, a Principal Component Analysis is carried out over the characteristic variables. The resulting principal components are linearly uncorrelated each other and will be used jointly with the time variable as predictors in the classifying first-order additive HSGP model. Let's denote the matrix $X=\{\bm{x}_{it}\}$ which contains the predictors, where $\bm{x}_{it} \in {\rm I\!R}^{D}$, $D=53$ (52 principal components + time) is the $D$-vector of characteristic variables of the parcel $i$ and time $t$. The use of a first-order additive model is justified due to the input variables correspond to principal components which are linearly uncorrelated each other.
%
%The observational model is a multinomial model with parameters the vector of probabilities $\bm{p}_{i}=\{p_{ik}\}_{k=1}^{K=5}$ of belonging to class $k$ per parcel $i$,
%%
%\begin{equation*}
%y_i \sim \text{multinomial}(\bm{p}_i).
%\end{equation*}
%
%\noindent The goal is to estimate the vector of probabilities $\bm{p}_i$ as a function of the input values, which is a multivariate function $f(\bm{x}_i):\bm{x_i}\in {\rm I\!R}^{D} \rightarrow \{f_k(\bm{x}_i)\}_{k=1}^K \in {\rm I\!R}^{K}$, related to the vector of probabilities $\bm{p}_i$ through the 'softmax' link function.
%%
%\begin{eqnarray*}
%\bm{p}_i = \text{softmax}(f(\bm{x}_i)).
%\end{eqnarray*}
%
%Each individual function $f_k(\bm{x})$ is modeled as a first-order additive model, 
%%
%\begin{eqnarray*}
%f_k(\bm{x}) \sim \sum_{d=1}^{D} g_d(x^d)
%%\mathcal{HSGP}(x^d, S(\bm{\lambda}), \theta_d),
%\end{eqnarray*}
%
%\noindent where each individual component $g_d(x^d)$ is modeled as a unidimensional HSGP model,
%%
%\begin{eqnarray*}
%g_d(x^d) \sim \mathcal{HSGP}(x^d, S, \theta_d),
%\end{eqnarray*}
%
%In the HSGP model, the function $g_d(x^d)$, evaluated at input value $x^d \in {\rm I\!R}$, is approximated as in Equation (\ref{approxf}), with the square exponential spectral density $S$ as in Equation (\ref{eq:specdens_inf}), and eigenvalues $\lambda_j$  and eigenfunctions $\phi_j$ as in Equations (\ref{eigenvalue}) and (\ref{eigenfunction}). The vector of hyperparameters $\theta_d=\{\alpha_d,\ell_d\}$ contains the marginal variance $\alpha_d$ and lengthscale $\ell_d$ of the HSGP process. 
%
%For each individual component $g_d(x^d)$ modeled as a HSGP model, $m$=15 basis functions and a boundary factor $c$=2.5 were used. All the input variables were previously standarized with the exception of the time variable.
%
%After the adjustment of the model, the lengthscales estimates $\{\hat{\ell}_d\}_{d=1}^{D=14}$ normalized by half of the input range ($\frac{2\cdot \hat{\ell}_d}{|x^d_{max}-x^d_{min}|}$) are all bigger than the minimun lengthscale reported by Figure \ref{fig6_lscale_vs_J_vs_c} as function of $m$, $c$. Which means that the used number of basis functions ($m=15$) and boundary factor ($c=2.5$) are suitable values for modeling the data. 
%
%Table \ref{tab1} shows the confusion classification matrix after fit the model following a $Q$-fold cross-validation procedure over the training data. Every fold was composed of $Q$=10 observations.
%
%\begin{table}
%\begin{center}
%\begin{tabular}{|c|*{6}{c|}}\hline
%\backslashbox{Estimate}{True} & \multicolumn{1}{p{1.5cm}|}{\centering caind \\(k=1)} &  \multicolumn{1}{p{1.5cm}|}{\centering calign \\(k=2)} & \multicolumn{1}{p{1.5cm}|}{\centering irr \\(k=3)} & \multicolumn{1}{p{1.5cm}|}{\centering aband \\(k=4)} & \multicolumn{1}{p{1.5cm}|}{\centering young \\(k=5)} & \multicolumn{1}{p{1.5cm}|}{\centering } \\ 
%\hline \multicolumn{1}{|p{3cm}|}{ \centering caind (k=1)} &90&39&14&3&11&42\%\\
%\hline \multicolumn{1}{|p{3cm}|}{\centering calign (k=2)} &46&301&8&2&3&16\%\\
%\hline \multicolumn{1}{|p{3cm}|}{\centering irr (k=3)}  &8&4&59&4&1&19\%\\
%\hline \multicolumn{1}{|p{3cm}|}{\centering aband (k=4)}  &5&2&6&342&5&5\%\\
%\hline \multicolumn{1}{|p{3cm}|}{\centering young (k=5)}  &8&2&1&0&38&19\%\\
