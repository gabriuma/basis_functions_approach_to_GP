...
%S_{\nu=\frac{5}{2}}(w)&= \frac{16}{3}\sigma^2 \frac{\sqrt{3}}{\ell}^{5}\left(\frac{5}{\ell^2} + \omega^2\right)^{-3}, \label{eq:specdens_52} 
\end{align}
...
\begin{figure}
\centering
\subfigure{\includegraphics[scale=0.44]{fig3_lscale_vs_J_vs_c.pdf}}
\subfigure{\includegraphics[scale=0.44, trim = 0mm 0mm 0mm 0mm, clip]{fig3_lscale_vs_J_vs_c_zoomin.pdf}}
