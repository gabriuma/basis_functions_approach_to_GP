...
\begin{figure}
\centering
\subfigure{\includegraphics[scale=0.47, trim = 0mm 0mm 0mm 10mm, clip]{fig1_Post_J.pdf}}
\subfigure{\includegraphics[scale=0.47, trim = 25mm 0mm 0mm 10mm, clip]{fig1_Cov_J.pdf}}
...
\begin{figure}
\centering
\subfigure{\includegraphics[scale=0.47, trim = 0mm 0mm 0mm 10mm, clip]{fig2_Post_L.pdf}}
\subfigure{\includegraphics[scale=0.47, trim = 25mm 0mm 0mm 10mm, clip]{fig2_Cov_L.pdf}}
...
\begin{figure}
\centering
\subfigure{\includegraphics[scale=0.41, trim = 0mm 3mm 0mm 0mm, clip]{fig4_Post_&_Cov_part1.pdf}}
\subfigure{\includegraphics[scale=0.41, trim = 0mm 3mm 0mm 3mm, clip]{fig4_Post_&_Cov_part2.pdf}}
\subfigure{\includegraphics[scale=0.41, trim = 0mm 0mm 0mm 3mm, clip]{fig4_Post_&_Cov_part3.pdf}}
\caption{Posterior predictive mean functions and covariance functions of both regular GP model and HSGP model for different number of basis functions $m$ and values of the boundary factor $c$.} 
  \label{fig4_Post_&_Cov_part1}
\end{figure}

\begin{figure}
\centering
\subfigure{\includegraphics[scale=0.44]{fig5_MSE_vs_J.pdf}}
\subfigure{\includegraphics[scale=0.44]{fig5_MSE_vs_c.pdf}}
...
\begin{figure}
\centering
\subfigure{\includegraphics[scale=0.48, trim = 0mm 0mm 5mm 0mm, clip]{fig6_lscale_vs_J.pdf}}
\subfigure{\includegraphics[scale=0.48, trim = 31mm 0mm 0mm 0mm, clip]{fig6_magnitud_vs_J.pdf}}
