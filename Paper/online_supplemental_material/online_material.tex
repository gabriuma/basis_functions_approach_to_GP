...
\usepackage{soul}
\usepackage{xcolor}
\graphicspath{{../manuscript_v2/images/}}
...
\end{tabular}
\end{center}
\caption{(a) Data-generating function. (b) Posterior mean predictive function of the GP model. (c) Posterior mean predictive function of the HSGP model. (d) Posterior mean predictive function of the splines model. Sample points are plotted as circles}
...
\caption{Error between the data-generating mean function and the posterior mean of the GP (a), HSGP (b) and spline (c) models. Sample points are plotted as circles.}
...
\caption{(a) Posterior mean predictive functions of the GP model. (b) Posterior mean predictive functions of the HSGP model. (c) Posterior mean predictive functions of the spline (SP) model. Samples observations of suffering (red points) and not suffering (blue points) form the disease are plotted.}
