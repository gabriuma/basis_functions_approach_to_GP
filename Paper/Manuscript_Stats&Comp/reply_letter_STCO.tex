...
%Paul: all responses will be send to all reviewers anyway
...
%Paul: This list is way too long and detailed and appears to be redundant at times. I recommend focusing on between 4 and 7 or so points but more will be too much.
...
%Paul: Don't forget the thank the reviewers for their comments to show some more appreciation of their comments and time they put into the review.
...
%Paul: The statement below is incorrect. I have not implemented the diagnostic procedure in brms.
...
%Paul: I recommend highlighting either the reviewers comments or our responses in bold to clearly differentiate what the reviewers wrote and what we wrote. Example below.
