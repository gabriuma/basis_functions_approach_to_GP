...
\author{Gabriel Riutort-Mayol$^{1*}$, Michael R. Andersen$^2$, Paul-Christian Bürkner$^{3}$, Aki Vehtari$^{3}$}
...
\end{align}
\todo{Is it only purpose that only some equations have numbers? Res: Only text referenced equations have number (Gabi). }
